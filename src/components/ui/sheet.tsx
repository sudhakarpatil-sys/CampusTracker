...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-border bg-surface-raised p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => <SheetPrimitive.Title ref={ref} className={cn("text-lg font-semibold font-display text-foreground", className)} {...props} />);
