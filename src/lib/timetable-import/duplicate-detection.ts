 ...
 * revised timetable for the same branch/semester/division). Only
 * checkable once AI structuring has run. */
export async function findContentDuplicate(
  ...
  if (division) query = query.eq("detected_division", division);
